...
class Demand():
    ...
    def generate_demand(self):
        ...
        y_growth = self.x * .025
        # stack the curves
        self.y_all = y_weekly + y_summer + y_peaks + y_recover_short + y_recover_long + y_growth + 20
    ...
    def add_sudden_change(self,
        ...
        y_sudden = 1 / (1 + np.exp(-(x_sudden-365)/self.sc_steepness)) * self.sc_magnitude
